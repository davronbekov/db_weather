...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $response = DB::query("INSERT INTO `Service` (name, params_url, license) VALUES (?,?,?)",
    ...
    <div class="app" id="app">
        ...
        <article class="content item-editor-page">
            <div class="title-block">
                <h3 class="title"> Add new service <span class="sparkline bar" data-type="bar"></span>
                </h3>
            </div>

            <form name="item" action="service_create.php" method="post">
                <div class="card card-block">
                    <div class="form-group row justify-content-center">
                        <label class="col-sm-2 form-control-label text-xs-right"> Name: </label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control boxed" name="name" placeholder="" required>
...
<!--                            <div class="valid-feedback"></div>-->
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control boxed" name="license" placeholder="" required>
                        </div>
                    </div>
                    <div class="form-group row justify-content-center">
                        <label class="col-sm-2 form-control-label text-xs-right"> Url: </label>
                        <div class="col-sm-5">
                            <input type="url" class="form-control boxed" name="params_url" placeholder="" required>
                        </div>
                    </div>
