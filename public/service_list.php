<?php
include '../db.php';
$result = DB::query("select service.name, service.license, GROUP_CONCAT(provides.map_id)
from service
left join provides using(name) 
group by service.name, service.license;",[]);
...
<head>
    ...
    <link rel="stylesheet" href="/db_weather/public/css/vendor.css">
    ...
    <script>
        ...
        if (themeName)
        {
            document.write('<link rel="stylesheet" id="theme-style" href="/db_weather/public/css/app-' + themeName + '.css">');
        }
        else
        {
            document.write('<link rel="stylesheet" id="theme-style" href="/db_weather/public/css/app.css">');
        }
    </script>
</head>
<body>
                            ...
                            <ul class="notifications-container">
                                <li>
                                    <a href="" class="notification-item">
                                        <div class="img-col">
                                            <div class="img" style="background-image: url('/db_weather/public/assets/faces/3.jpg')"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                                ...
                                <li>
                                    <a href="" class="notification-item">
                                        <div class="img-col">
                                            <div class="img" style="background-image: url('/db_weather/public/assets/faces/5.jpg')"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                                ...
                                <li>
                                    <a href="" class="notification-item">
                                        <div class="img-col">
                                            <div class="img" style="background-image: url('/db_weather/public/assets/faces/8.jpg')"></div>
                                        </div>
                                        <div class="body-col">
                                            <p>
                    ...
                    <ul class="sidebar-menu metismenu" id="sidebar-menu">
                        ...
                        <li class="active open">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    <a href="user_edit.php"> Item Editor </a>
                                </li>
                            </ul>
                        </li>
                        <li>
        ...
        <article class="content items-list-page">
            <div class="title-search-block">
                <div class="title-block">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="title"> Items <a href="user_edit.php" class="btn btn-primary btn-sm rounded-s"> Add New </a>
...
<!--                                </div>-->
                                ...
                                <div class="item-col fixed pull-left item-col-title">
                                    ...
                                    <div>
                                        <a href="user_edit.php" class="">
                                            <h6><?php echo $row['license'];?></h6>
                                        </a>
                                    </div>
                                </div>

                                <div class="item-col item-col-sales">
                                    <div class="item-heading">Maps</div>
                                    <div class="no-overflow">
                                    <h6><?php echo $row['GROUP_CONCAT(provides.map_id)'];?></h6>
                                    </div>
                                </div>
                                    ...
                                    <div class="item-actions-dropdown">
                                        ...
                                        <div class="item-actions-block">
                                            <ul class="item-actions-list">
                                                ...
                                                <li>
                                                    <a class="edit" href="service_edit.php ?">
...
<script src="/db_weather/public/js/vendor.js"></script>
<script src="/db_weather/public/js/app.js"></script>
</body>
</html>
