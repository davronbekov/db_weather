...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $response = DB::query("INSERT INTO `Map` (map_id, description) VALUES (?,?)",
        [$map_id, $description]);
    ...
    <div class="app" id="app">
        ...
        <article class="content item-editor-page">
            <div class="title-block">
                <h3 class="title"> Add new Map <span class="sparkline bar" data-type="bar"></span>
                </h3>
            </div>

            <form name="item" action="map_create.php" method="post">
                <div class="card card-block">
                    <div class="form-group row justify-content-center">
                        <label class="col-sm-2 form-control-label text-xs-right"> Map ID: </label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control boxed" name="map_id" placeholder="" required>
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control boxed" name="description" placeholder="" required>
                        </div>
                    </div>
