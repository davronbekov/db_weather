...
$name = $_GET["name"];
$result = DB::query("SELECT * FROM SERVICE where name=?", [$name]);
if (!$result->fetch()) {
    header("Location: /db_weather/public/service_edit.php");
    die();
}
            ...
            <form name="item" action="service_create.php" method="post">
                <div class="card card-block">
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control boxed" name="url" placeholder="" required>
                        </div>
                    </div>
