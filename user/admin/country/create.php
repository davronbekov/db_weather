 ...
 */
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $checkCountry = Country::getItem(['country_name' => $_POST['country_name']]);
        if(!$checkCountry){
            Country::insertItem([
                'country_name' => $_POST['country_name'],
            ]);
        }else
            $errorClass['country_name'] = 'is-invalid';
            ...
            <form method="post">
                <div class="card card-block">
                    ...
                    <div class="form-group row justify-content-center">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control boxed <?= $errorClass['country_name'] ?>" name="country_name" placeholder="Uzbekistan" required>
