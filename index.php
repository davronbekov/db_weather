...
//
//
//$response = DB::query("SELECT * FROM `User` where login like ?", ["Davron"]);
//while ($raw = $response->fetch()) {
//    echo $raw["login"];
//}
...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  ...
  <nav class="my-2 my-md-0 mr-md-3">
    ...
    <a class="p-2 text-dark" href="#">Map</a>
  ...
  <footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
      <div class="col-12 col-md">
        <img class="mb-2" src="public/minion.jpg" alt="" width="256">
        <small class="d-block mb-3 text-muted">© 2017-2019</small>
      </div>
      <div class="col-6 col-md">
        <h5>Features</h5>
        <ul class="list-unstyled text-small">
          <li><a class="text-muted" href="#">Hot stuff</a></li>
